 ...
 * 
 */
update_option('tp_envato_purchase_code', 'GPL001122334455AA6677BB8899CC000');
class Theme_Register {
	...
	public function tp_register_theme_options() {
		...
		if (!current_user_can('manage_options')) {
			wp_die(__('You do not have sufficient permissions to access this page.', 'harry'));
		}
		...
		<form method="post" id="purchase_code_form" class="notice notice-info">
			<div class="theme-register-wrapper">
				<div class="theme-register-header">
					<h2 class="hndle ui-sortable-handle"><?php esc_html_e('Register Theme','harry'); ?></h2>
				</div>
				<p><?php esc_html_e('You\'re almost done. Just one more step. In order to gain full access
					to all demos, premium plugins and support, please register your theme\'s purchase code.','harry'); ?></p>
				<h4><?php esc_html_e('Your Envato Purchase Code','harry'); ?></h4>
				...
				<p>
					<a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank"><?php esc_html_e('Where to find the code?','harry'); ?></a>
				</p>
				...
				<p>
					<label>
						...
						installations is a copyright violation.','harry'); ?>
					</label>
					<a href="https://themeforest.net/licenses/terms/regular" target="_blank"><?php esc_html_e('License details.','harry'); ?></a>
				</p>
	
				<p class="tp-actions">
					<button class="button button-primary" id="register" name="register_theme"><?php esc_html_e('Register Theme','harry'); ?></button>
				</p>
			</div>
		</form>
		<div id="error"></div>
		...
		<div class="wrap">
					...
					<div class="welcome-panel-column-container">
						<div class="welcome-panel-column">
							...
							<div class="welcome-panel-column-content">
								<h3>Theme Support</h3>
								<p><?php echo esc_html__('Envato allows 1 license for 1 project located on 1 domain. It means that 1 purchase key can be used only for 1 site. Each additional site will require an additional purchase key.','harry'); ?>
								</p>
			...
			<button class="button button-primary" id="deactivate"><?php esc_html_e('Deactivate License Key', 'harry'); ?></button>
		</div>
		<?php endif; endif;
	...
	public function tp_tgmpa_filter_action_links( $action_links, $item_slug, $item, $view_context ) {
		...
		if ( 'External Source' === $source && !self::tp_is_theme_registered() ) {
			...
			$action_links = array(
				'tp_registration_required' => sprintf( __( '<a style="color: red;" href="%s">Register Theme To Unlock It</a>', 'harry' ), esc_url( admin_url( 'themes.php?page=register-theme' ) ) ),
			);
		}
	...
	public function tp_prevent_modal(){
		...
		<div id="register-modal" class="tp-modal">
			...
			<div class="tp-modal-content">
				...
				<p><?php esc_html_e('Please register theme with your evato purchase code to activate this plugin.', 'harry'); ?> <a href="<?php echo esc_url( admin_url( 'themes.php?page=register-theme' ) ); ?>"><?php esc_html_e('Register Theme', 'harry'); ?></a></p>
			</div>
