...
function harry_scripts() {
    ...
    */
    ...
    wp_enqueue_style( 'harry-core', HARRY_THEME_CSS_DIR . 'harry-core.css', [] );
    wp_enqueue_style( 'harry-unit', HARRY_THEME_CSS_DIR . 'harry-unit.css', [] );
    ...
    wp_enqueue_script( 'harry-main', HARRY_THEME_JS_DIR . 'main.js', [ 'jquery' ], false, true );
