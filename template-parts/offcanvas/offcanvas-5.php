      ...
      <div class="offcanvas__area offcanvas__area-5">
         <div class="offcanvas__wrapper offcanvas__wrapper-5">
            ...
            <div class="offcanvas__shape">
               <img class="offcanvas__shape-3" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/shape/offcanvas-shape-3.png' ?>" alt="<?php echo esc_attr__('Shape','harry'); ?>">
            </div>
            <?php endif; ?>
