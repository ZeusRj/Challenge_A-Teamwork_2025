...
?>
      ...
      <div class="offcanvas__area offcanvas__area-3">
         ...
         <div class="offcanvas__shape">
            <img class="offcanvas__shape-2" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/shape/offcanvas-shape-2.png' ?>" alt="<?php echo esc_attr__('shape','harry'); ?>">
         </div>
         <?php endif; ?>
