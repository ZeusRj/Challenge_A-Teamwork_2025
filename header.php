         ...
         <div id="loading-center">
            <div id="loading-center-absolute">
               ...
               <div class="preloader__content text-center">
                  ...
                  <h3 class="preloader__title d-none d-md-block"><?php echo esc_html($harry_preloader_text); ?></h3>
                  <?php endif;?>

                  <!-- for sm device -->
                  <?php if ( !empty( $harry_preloader_text ) ): ?>
                  <h3 class="preloader__title preloader__title-sm d-none d-sm-block d-md-none"><?php echo esc_html($harry_preloader_text); ?></h3>
                  <?php endif;?>

                  <!-- for xs device -->
                  <?php if ( !empty( $harry_preloader_text ) ): ?>
                  <h3 class="preloader__title preloader__title-xs d-sm-none"><?php echo esc_html($harry_preloader_text); ?></h3>
                  <?php endif;?>
