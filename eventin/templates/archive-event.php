...
<div class="pt-100 pb-100">
    ...
    <div class="etn-event-archive-wrap etn_search_item_container" data-json='<?php echo json_encode([
            "error_content" => [
                "title" => esc_html__('Nothing found!', 'harry'),
                "exerpt" => esc_html__('It looks like nothing was found here. Maybe try a search?','harry')
            ]
        ]); ?>'>
        <div class="etn-container">
            <div class="etn-row etn-event-wrapper">
                ...
                if ( have_posts() ) {
                    ...
                    ?>
                        <p><?php echo esc_html__('No Event found!', 'harry'); ?></p>
                    <?php
                }
                wp_reset_postdata();     
            }else if( is_archive() ) {
